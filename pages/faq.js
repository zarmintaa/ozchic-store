      ...
      <div className="grid grid-cols-1 gap-5 lg:w-7/12 md:w-9/12 sm:w-full px-2.5 lg:px-0 mx-auto">
        <div className="grid gap-2 shadow p-5 rounded">
          ...
          <p className="text-gray-700 font-light">
            ...
            yang ingin dibeli dan tambahkan ke keranjang. Setelah itu dihalaman
            cart, pengguna dapat melakukan pemesanan dengan mengisi form
            pemesanan, setelah itu pengguna dapat melihat pesanan pada halaman
            transaksi.
          </p>
        </div>
        ...
        <div className="grid gap-2 shadow p-5 rounded h-fit">
          ...
          <p className="text-gray-700 font-light">
            ...
            transfer pada bank BCA, BNI ke rekening Ozchic atau melalui e-wallet
            Ovo atau Dana.
          </p>
        </div>
        <div className="grid gap-2 shadow p-5 rounded">
          ...
          <p className="text-gray-700 font-light">
            ...
            pemesanan melalui chat pada kontak kami, jika produk sudah di proses
            oleh kami maka produk yang dipesan sudah tidak bisa dibatalkan.
          </p>
        </div>
        <div className="grid gap-2 shadow p-5 rounded">
          <h1 className="text-3xl font-semibold font-f-poppins font-medium text-gray-900">
